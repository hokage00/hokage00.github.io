...
function GetBooking() {
    let url = 'https://api.sheety.co/562e27dd1cf60f500bcbd29ddcfff3cc/bookingApp/bookings';
    fetch(url)
...
function DeleteBooking(id) {
    let url = 'https://api.sheety.co/562e27dd1cf60f500bcbd29ddcfff3cc/bookingApp/bookings/2'; + id;
    fetch(url, {
        method: 'DELETE',
    })
        .then(() => {
